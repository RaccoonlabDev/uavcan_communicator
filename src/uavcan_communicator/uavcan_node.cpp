...
class BaroStaticPressure: public RosToUavcanConverter{
    ...
    typedef drone_communicators::StaticPressure IN_ROS_MSG;
...
class BaroStaticTemperature: public RosToUavcanConverter{
    ...
    typedef drone_communicators::StaticTemperature IN_ROS_MSG;
...
class DiffPressure: public RosToUavcanConverter{
    ...
    typedef drone_communicators::RawAirData IN_ROS_MSG;
